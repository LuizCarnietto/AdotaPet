import {
  composeRefs,
  useComposedRefs
} from "./chunk-JBPDEBLI.js";
import {
  require_jsx_runtime
} from "./chunk-UJ7ETYOI.js";
import {
  require_react_dom
} from "./chunk-BUVZ6QDC.js";
import {
  require_react
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe2, getSnapshot) {
        didWarnOld18Alpha || void 0 === React81.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React81 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React81.useState, useEffect40 = React81.useEffect, useLayoutEffect6 = React81.useLayoutEffect, useDebugValue = React81.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
// node_modules/radix-ui/node_modules/@radix-ui/react-accessible-icon/dist/index.mjs
var dist_exports2 = {};
...
// node_modules/radix-ui/node_modules/@radix-ui/react-visually-hidden/dist/index.mjs
var dist_exports = {};
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React47.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React47.Children.count(newElement) > 1)
            return React47.Children.only(null);
...
// node_modules/radix-ui/node_modules/@radix-ui/react-form/dist/index.mjs
var dist_exports19 = {};
...
var NAME6 = "VisuallyHidden";
var VisuallyHidden2 = React55.forwardRef(
  (props, forwardedRef) => {
...
VisuallyHidden2.displayName = NAME6;
var Root13 = VisuallyHidden2;
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React59.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React59.Children.count(newElement) > 1)
            return React59.Children.only(null);
          return React59.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime37.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React59.isValidElement(newElement) ? React59.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React64.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime43.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React64.isValidElement(newElement) ? React64.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var VisuallyHidden3 = React65.forwardRef(
  (props, forwardedRef) => {
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime45.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime45.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime45.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime45.jsx)(
        ...
        isFormControl2 ? (0, import_jsx_runtime45.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
            ...
            form,
            children: [
              value === void 0 ? (0, import_jsx_runtime45.jsx)("option", { value: "" }) : null,
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? (0, import_jsx_runtime45.jsx)(import_jsx_runtime45.Fragment, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME10 = "SelectPortal";
var SelectPortal = (props) => {
  return (0, import_jsx_runtime45.jsx)(Portal, { asChild: true, ...props });
};
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM5.createPortal(
        (0, import_jsx_runtime45.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime45.jsx)(Collection7.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime45.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
    return (0, import_jsx_runtime45.jsx)(SelectContentImpl, { ...props, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime45.jsx)(Combination_default, { as: Slot11, allowPinchZoom: true, children: (0, import_jsx_runtime45.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
      ...
      (0, import_jsx_runtime45.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime45.jsx)(
        Primitive.div,
        {
...
var SelectGroup = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime45.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime45.jsx)(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React66.useMemo(
      () => (0, import_jsx_runtime45.jsx)("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value),
    ...
    return (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [
      (0, import_jsx_runtime45.jsx)(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime45.jsx)(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectScrollUpButton = React66.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? (0, import_jsx_runtime45.jsx)(
...
var SelectScrollDownButton = React66.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? (0, import_jsx_runtime45.jsx)(
    SelectScrollButtonImpl,
    {
      ...props,
      ref: composedRefs,
...
var SelectSeparator = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime45.jsx)(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
var SelectArrow = React66.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime45.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime47.jsx)(
      SliderProvider,
      {
        ...
        orientation,
        form,
        children: (0, import_jsx_runtime47.jsx)(Collection8.Provider, { scope: props.__scopeSlider, children: (0, import_jsx_runtime47.jsx)(Collection8.Slot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime47.jsx)(
          SliderOrientation,
          {
...
var SliderThumb = React68.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime47.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime47.jsxs)(
      "span",
      {
        ...
        children: [
          (0, import_jsx_runtime47.jsx)(Collection8.ItemSlot, { scope: props.__scopeSlider, children: (0, import_jsx_runtime47.jsx)(
            Primitive.span,
            {
              role: "slider",
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React69.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React69.Children.count(newElement) > 1)
            return React69.Children.only(null);
          return React69.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime48.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React69.isValidElement(newElement) ? React69.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Switch = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime49.jsxs)(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
...
var TabsContent = React71.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime50.jsx)(Presence, { present: forceMount || isSelected, children: ({ present }) => (0, import_jsx_runtime50.jsx)(
      Primitive.div,
      {
        "data-state": isSelected ? "active" : "inactive",
        "data-orientation": context.orientation,
...
var VISUALLY_HIDDEN_STYLES4 = Object.freeze({
  // See: https://github.com/twbs/bootstrap/blob/main/scss/mixins/_visually-hidden.scss
  position: "absolute",
  border: 0,
  width: 1,
...
var NAME9 = "VisuallyHidden";
var VisuallyHidden4 = React72.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime51.jsx)(
      Primitive.span,
      {
        ...props,
        ref: forwardedRef,
        style: { ...VISUALLY_HIDDEN_STYLES4, ...props.style }
      }
    );
  }
);
VisuallyHidden4.displayName = NAME9;
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React73.useState(0);
  const isFocusedToastEscapeKeyDownRef = React73.useRef(false);
  const isClosePausedRef = React73.useRef(false);
  if (!label.trim()) {
    console.error(
      `Invalid prop \`label\` supplied to \`${PROVIDER_NAME}\`. Expected non-empty \`string\`.`
    );
  }
  return (0, import_jsx_runtime52.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime52.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React73.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React73.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React73.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const wrapperRef = React73.useRef(null);
    const headFocusProxyRef = React73.useRef(null);
    const tailFocusProxyRef = React73.useRef(null);
    ...
    const getSortedTabbableCandidates = React73.useCallback(
      ({ tabbingDirection }) => {
    ...
    return (0, import_jsx_runtime52.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime52.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime52.jsx)(Collection9.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime52.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime52.jsx)(
            FocusProxy,
            {
...
var FocusProxy = React73.forwardRef(
  (props, forwardedRef) => {
...
var Toast = React73.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime52.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime52.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React73.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React73.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React73.useRef(null);
    const swipeDeltaRef = React73.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React73.useRef(0);
    const closeTimerRemainingTimeRef = React73.useRef(duration);
    ...
    const startTimer = React73.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React73.useMemo(() => {
      return node ? getAnnounceTextContent(node) : null;
    }, [node]);
    if (!context.viewport)
      return null;
    return (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime52.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime52.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime52.jsx)(Collection9.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime52.jsx)(
          Root4,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React73.useState(false);
  const [isAnnounced, setIsAnnounced] = React73.useState(false);
  useNextFrame(() => setRenderAnnounceText(true));
  React73.useEffect(() => {
    const timer = window.setTimeout(() => setIsAnnounced(true), 1e3);
    return () => window.clearTimeout(timer);
  }, []);
  return isAnnounced ? null : (0, import_jsx_runtime52.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime52.jsx)(VisuallyHidden4, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime52.jsxs)(import_jsx_runtime52.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React73.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...titleProps } = props;
    return (0, import_jsx_runtime52.jsx)(Primitive.div, { ...titleProps, ref: forwardedRef });
  }
);
ToastTitle.displayName = TITLE_NAME3;
var DESCRIPTION_NAME3 = "ToastDescription";
var ToastDescription = React73.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...descriptionProps } = props;
    return (0, import_jsx_runtime52.jsx)(Primitive.div, { ...descriptionProps, ref: forwardedRef });
  }
);
ToastDescription.displayName = DESCRIPTION_NAME3;
var ACTION_NAME2 = "ToastAction";
var ToastAction = React73.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime52.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime52.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
ToastAction.displayName = ACTION_NAME2;
var CLOSE_NAME3 = "ToastClose";
var ToastClose = React73.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToast, ...closeProps } = props;
    const interactiveContext = useToastInteractiveContext(CLOSE_NAME3, __scopeToast);
    return (0, import_jsx_runtime52.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime52.jsx)(
      Primitive.button,
      {
        type: "button",
        ...closeProps,
...
var ToastAnnounceExclude = React73.forwardRef((props, forwardedRef) => {
...
var NAME10 = "Toggle";
var Toggle = React74.forwardRef((props, forwardedRef) => {
...
var ToggleGroup = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime54.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime54.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime54.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime54.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react8.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime54.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime54.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime54.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime54.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime54.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime54.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react8.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime54.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime54.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime54.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var NAME11 = "Separator";
var DEFAULT_ORIENTATION2 = "horizontal";
var ORIENTATIONS2 = ["horizontal", "vertical"];
var Separator5 = React76.forwardRef((props, forwardedRef) => {
...
var Toolbar = React77.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, orientation = "horizontal", dir, loop = true, ...toolbarProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    const direction = useDirection(dir);
    return (0, import_jsx_runtime56.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime56.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarSeparator = React77.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarButton = React77.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...buttonProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime56.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime56.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
ToolbarButton.displayName = BUTTON_NAME;
var LINK_NAME2 = "ToolbarLink";
var ToolbarLink = React77.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...linkProps } = props;
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime56.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime56.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleGroup = React77.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React77.forwardRef(
  (props, forwardedRef) => {
    const { __scopeToolbar, ...toggleItemProps } = props;
    const toggleGroupScope = useToggleGroupScope(__scopeToolbar);
    const scope = { __scopeToolbar: props.__scopeToolbar };
    return (0, import_jsx_runtime56.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime56.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React78.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React78.Children.count(newElement) > 1)
            return React78.Children.only(null);
          return React78.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return (0, import_jsx_runtime57.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React78.isValidElement(newElement) ? React78.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React78.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var VISUALLY_HIDDEN_STYLES5 = Object.freeze({
  // See: https://github.com/twbs/bootstrap/blob/main/scss/mixins/_visually-hidden.scss
  position: "absolute",
  border: 0,
  width: 1,
...
var NAME12 = "VisuallyHidden";
var VisuallyHidden5 = React79.forwardRef(
  (props, forwardedRef) => {
    return (0, import_jsx_runtime58.jsx)(
      Primitive.span,
      {
        ...props,
        ref: forwardedRef,
        style: { ...VISUALLY_HIDDEN_STYLES5, ...props.style }
      }
    );
  }
);
VisuallyHidden5.displayName = NAME12;
var Root21 = VisuallyHidden5;
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React80.useRef(true);
  const isPointerInTransitRef = React80.useRef(false);
  const skipDelayTimerRef = React80.useRef(0);
  React80.useEffect(() => {
  ...
  return (0, import_jsx_runtime59.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React80.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React80.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React80.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const [trigger, setTrigger] = React80.useState(null);
  const contentId = useId();
  const openTimerRef = React80.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React80.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React80.useMemo(() => {
    return open ? wasOpenDelayedRef.current ? "delayed-open" : "instant-open" : "closed";
  }, [open]);
  const handleOpen = React80.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  const handleDelayedOpen = React80.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
  ...
  return (0, import_jsx_runtime59.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime59.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React80.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current)
          handleDelayedOpen();
        else
          handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React80.useCallback(() => {
...
var TooltipTrigger = React80.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React80.useRef(false);
    const hasPointerMoveOpenedRef = React80.useRef(false);
    const handlePointerUp = React80.useCallback(() => isPointerDownRef.current = false, []);
    React80.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime59.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime59.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime59.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React80.forwardRef(
  (props, forwardedRef) => {
...
var TooltipContentHoverable = React80.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React80.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React80.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React80.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React80.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React80.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime59.jsxs)(
          Content4,
          {
            ...
            children: [
              (0, import_jsx_runtime59.jsx)(Slottable11, { children }),
              (0, import_jsx_runtime59.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime59.jsx)(Root21, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React80.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime59.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
export {
  ...
  dist_exports39 as Toggle,
  dist_exports40 as ToggleGroup,
  dist_exports41 as Toolbar,
  dist_exports43 as Tooltip,
